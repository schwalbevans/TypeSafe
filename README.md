...
[ ] v0.2: Support for ChatGPT Desktop App & VS Code.

[ ] v0.3: "Sanitize & Send" Popup Menu.

[ ] v0.4: File Upload Interception (.pdf, .docx).

[ ] v1.0: Signed Windows Installer (.exe).
...
💼 Commercial License
Do you want to use RedactOS in your company without open-sourcing your modifications? We offer a Commercial License that removes the AGPL restrictions and includes:
